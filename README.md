...
[![CI](https://github.com/Oefenweb/ansible-mariadb-server/workflows/CI/badge.svg)](https://github.com/Oefenweb/ansible-mariadb-server/actions?query=workflow%3ACI)
